...
const FrameComponent6: NextPage<FrameComponent6Type> = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch [background:linear-gradient(180deg,_#fbfdff,_#92c557)] flex flex-col items-start justify-start pt-[79px] pb-0 pl-[37px] pr-9 box-border gap-[32.9px] max-w-full text-right text-11xl text-black font-open-sans mq1050:pt-[51px] mq1050:box-border mq750:gap-4 mq750:pt-[33px] mq750:box-border ${className}`}
    >
      <div className="w-[1440px] h-[987px] relative [background:linear-gradient(180deg,_#fbfdff,_#92c557)] hidden max-w-full" />
      <div className="self-stretch flex flex-row items-start justify-center py-0 pl-0 pr-[7px] box-border max-w-full">
        <div className="flex flex-row items-end justify-start gap-[77px] max-w-full mq1050:flex-wrap mq1225:gap-[38px] mq750:gap-[19px]">
          <div className="w-[488px] flex flex-col items-start justify-start pt-0 px-0 pb-[173px] box-border min-h-[308px] max-w-full mq1050:flex-1 mq750:min-w-full">
            <div className="self-stretch flex flex-col items-end justify-start gap-[18px]">
              <h1 className="m-0 relative text-inherit font-normal font-inherit z-[1] mq450:text-lg mq750:text-5xl">
                Join the Daya Squad today! Make a difference and earn big
                rewards.
              </h1>
              <div className="w-[169px] flex flex-row items-start justify-end py-0 px-1 box-border">
                <button className="cursor-pointer [border:none] pt-2.5 px-[25px] pb-[9.4px] bg-cornflowerblue flex-1 shadow-[0px_20px_35px_rgba(241,_165,_1,_0.15)] rounded-15xl flex flex-row items-start justify-start z-[1] hover:bg-mediumpurple">
          ...
          <img
            className="h-[488.1px] flex-1 relative max-w-full overflow-hidden object-cover min-w-[339px] z-[1] mq450:min-w-full"
            loading="lazy"
            alt=""
            src="/6@2x.png"
          />
      ...
      <footer className="self-stretch rounded-t-11xl rounded-b-none bg-gray-200 flex flex-row items-start justify-between pt-[82px] pb-[55px] pl-[148px] pr-[105px] box-border max-w-full gap-5 z-[1] text-left text-mini text-gray-400 font-open-sans mq1225:flex-wrap mq1225:justify-center mq1225:pl-[74px] mq1225:pr-[52px] mq1225:box-border mq450:pt-[53px] mq450:pb-9 mq450:box-border mq750:pl-[37px] mq750:pr-[26px] mq750:box-border">
        ...
        <div className="flex flex-col items-start justify-start py-0 pl-0 pr-[26px] gap-[19px] text-mid text-yellowgreen font-dm-sans">
          ...
          <div className="self-stretch flex flex-row items-start justify-start gap-2.5 text-mini text-gray-400 font-open-sans">
            <div className="flex flex-col items-start justify-start gap-[22.7px]">
